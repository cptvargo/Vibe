    ...
    (e) => {
      ...
      if (fromHandle.current) {
        ...
        frameRef.current = requestAnimationFrame(() =>
          setStyle(delta, Math.min(delta * 0.18, 24)),
        );
        return;
      }
...
function FullPlayer({
  ...
  const bgColor = rawPrimary; // for gradient base

  // Always scroll to top when a new track starts
  useEffect(() => {
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            style={{ display: "flex", gap: 12, marginTop: 20, marginBottom: 8 }}
          >
            <button
              onClick={() => playAll(0)}
              style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div
                  style={{
                    ...
                    fontWeight: 500,
                    color:
                      player.currentTrack?.Id === t.Id ? accent : "#f1f5f9",
                    whiteSpace: "nowrap",
                    overflow: "hidden",
                    textOverflow: "ellipsis",
                  }}
...
function ArtistDetail({ artist, onClose, onAlbumSelect, player }) {
  ...
  return (
    ...
    >
      ...
      {/* Albums */}
      <div
        style={{ padding: "8px 20px 40px", position: "relative", zIndex: 1 }}
      >
        <div
          style={{
            display: "flex",
...
export default function App() {
  ...
  const playAndExpand = (tracks, index = 0) => {
    ...
    // Record play for hot track detection
